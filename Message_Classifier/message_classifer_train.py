...
class TrainMessageClassifer():
	def __init__(self,trainfile_name_path='TRAIN_SMS.csv'):
	...
	def train_SVMClassifier(self):
		...
		self.save(classifier,'message_base_classifier.model')
...
if __name__ == '__main__':
	messageclassifier= TrainMessageClassifer()
